		...
		<div id='MenuItem'>
			...
			<div id='MenuItemDetails'>
					<div id='MenuItemTitle'>
						<div id='MenuItemName'>".$foodItem->FoodName."</div>
						<div id='MenuItemRating'>
							...
							<span>".$foodItem->FoodRating."</span>
						</div>
					</div>
					<div id='MenuItemSubCategory'>".$foodItem->FoodType."</div>
					<div id='MenuItemPrice' class='ItemPrice'>Rs ".$foodItem->FoodPrice."</div>
						<div id='MenuItemFooter' class='ItemFooter'>
							<div id='MenuItemDuration'>
								...
								<span>".$foodItem->FoodPreparationTime." mins </span>
							</div>
